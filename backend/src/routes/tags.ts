...
import { validateCreateTag, validateUpdateTag, validateId } from '../middleware/validation';
...
router.post('/', validateCreateTag, asyncHandler(async (req: Request, res: Response<ApiResponse>) => {
...
router.put('/:id', validateUpdateTag, asyncHandler(async (req: Request, res: Response<ApiResponse>) => {
  const { id } = req.params;
  ...
  const tag = await tagRepository.update({ id, ...updateData } as UpdateTagInput);
  res.json({
    success: true,
    data: tag,
...
router.put('/:id/increment', validateId, asyncHandler(async (req: Request, res: Response<ApiResponse>) => {
  const { id } = req.params;
...
router.put('/:id/decrement', validateId, asyncHandler(async (req: Request, res: Response<ApiResponse>) => {
  const { id } = req.params;
...
router.post('/update-counts', asyncHandler(async (req: Request, res: Response<ApiResponse>) => {
