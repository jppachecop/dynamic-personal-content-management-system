...
export const MobileNavigation: React.FC<MobileNavigationProps> = ({ className }) => {
    const { state, createNote, logoutUser, setSelectedCategory, selectNote } = useApp();
    const { currentUser, categories, notes, selectedCategory, selectedNote } = state;
    ...
    return (
        <div className={cn("flex items-center justify-between p-4 bg-background border-b border-border", className)}>
            {selectedNote ? (
                <Button
                    variant="ghost"
                    size="icon"
            ...
            <div className="flex-1 text-center">
                <h1 className="text-lg font-semibold text-foreground truncate">
                    {selectedNote ? selectedNote.title : selectedCategory || 'Todas as Notas'}
                </h1>
            </div>
